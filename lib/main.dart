...
import 'package:front_end/splasscreen.dart';
...
class OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color myLightRed = Color(0xFFFFE3E3);
    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          title: "Welcome to Kamus Indonesia - Germany",
        ...
        PageViewModel(
          title: "Indonesia",
          body: "lorem ipsum dolor sit amet, consectet",
          image: _buildImage('indo.jpg'),
          decoration: pageDecoration2,
        ),
        PageViewModel(
          title: "Jerman",
          body: "lorem ipsum dolor sit amet, consectet",
          image: _buildImage('jerman.jpg'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Gunakan Dimapun kapanpun",
          body: "lorem ipsum dolor sit amet, consectet",
